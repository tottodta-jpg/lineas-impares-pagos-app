...
export default function App() {
  ...
  const parseAmount = (val) => {
    ...
    // CORRECCIÓN DEL PARSE ERROR AQUÍ:
                          ...
                          filteredTransactions.map((tx) => {
                            ...
                            return (
                              <tr key={tx.id} className="hover:bg-slate-50 dark:hover:bg-slate-700/20 transition-colors">
                                ...
                                <td className="px-6 py-5 text-base text-slate-600 dark:text-slate-400 font-mono font-medium truncate max-w-[200px]" title={tx.ref}>
                                  {tx.ref ? tx.ref.trim() : 'Bre-B'}
                                </td>
                                <td className="px-6 py-5">
